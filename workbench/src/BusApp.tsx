...
export default function BusApp() {
  ...
  return <main className="bm-app"><a href="#bm-search" className="bm-skip">跳至站牌搜尋</a><BusMap stops={stops} selected={selected} onPick={pick} />
    <aside className="bm-panel"><header className="bm-header"><a href="/delivery" aria-label="返回汽車路線"><ArrowLeft size={19} /></a><span className="bm-brand"><GitBranch size={18} /><strong>JEV Maps</strong></span><a className="bm-city" href="/delivery/compare">時間比較 ↗</a></header>
